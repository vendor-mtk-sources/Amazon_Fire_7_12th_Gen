...
/* Reg# 0x03*/
#define DBMDX_REGN_MIC_MUTE_DUR			0x80030000
/* Values */
#define DBMDX_REGV_KEEP_CURRENT_DUR		0x0800
#define DBMDX_REGV_MUTE_MIC1			0x1000
#define DBMDX_REGV_MUTE_MIC2			0x2000
#define DBMDX_REGV_MUTE_MIC3			0x3000
#define DBMDX_REGV_MUTE_MIC4			0x4000
#define DBMDX_REGV_MUTE_ALL_MICROPHONES		0x0000
...
#define DBMDX_REGV_GAIN_AFFECTS_MIC1		0x1000
#define DBMDX_REGV_GAIN_AFFECTS_MIC2		0x2000
#define DBMDX_REGV_GAIN_AFFECTS_MIC3		0x3000
#define DBMDX_REGV_GAIN_AFFECTS_MIC4		0x4000
#define DBMDX_REGV_GAIN_AFFECTS_ALL_MICS	0xF000
#define DBMDX_REGV_DIGITAL_GAIN_3_DB		0x0030
#define DBMDX_REGV_DIGITAL_GAIN_6_DB		0x0060
#define DBMDX_REGV_DIGITAL_GAIN_11_5_DB		0x00b8
...
/* Reg Value */
#define DBMDX_REGV_AUDIO_BUFFER_0_5_SEC		0x03e8
...
#define DBMDX_REGV_GET_AMOUNT_OF_ALLOC_BLOCKS_IN_DTCM	0x0003
#define DBMDX_REGV_GET_AMOUNT_OF_ALLOC_BLOCKS_IN_AHB	0x0004
#define DBMDX_REGV_GET_MIC_ENR_LEVEL			0x0005
...
/* Reg# 0x0F*/
#define DBMDX_REGN_LOAD_NEW_ACOUSTIC_MODEL	0x800F0000
/* Reg Value */
#define DBMDX_REGV_LOAD_PRIMARY_VT_MODEL	0x0000
#define DBMDX_REGV_LOAD_SECONDARY_VT_MODEL	0x0001
#define DBMDX_FILE_LOAD_INIT_OR_KILL_REL		0x00C0
#define DBMDX_REGV_LOAD_MODEL_TO_DTCM		0x0000
#define DBMDX_REGV_LOAD_MODEL_TO_AHB		0x0100
#define DBMDX_REGV_BLK_START_NUM_0		0x0000
#define DBMDX_REGV_BLK_START_NUM_1		0x0200
#define DBMDX_REGV_INIT_KILL_SET		0x0400
#define DBMDX_REGV_INIT_KILL_KILL		0x0C00
#define DBMDX_REGV_OP_TYPE_LOAD_FILE		0x0000
#define DBMDX_REGV_OP_TYPE_RELEASE_FILE		0x0800
#define DBMDX_REGV_LOAD_ENGINE_TYPE_VT1		0x1000
#define DBMDX_REGV_LOAD_ENGINE_TYPE_VT2		0x2000
#define DBMDX_REGV_LOAD_ENGINE_TYPE_VT3		0x3000
...
#define DBMDX_REGN_EVENTS_INDICATIONS_EN_CFG	0x80120000
...
/* Reg 0X14 */
#define DBMDX_REGN_DETECT_AND_SYS_EVENTS	0x80140000
/* Reg Value */
#define DBMDX_REGV_VT1_DET			0x0002
#define DBMDX_REGV_VT2_DET			0x0004
#define DBMDX_REGV_VT3_DET			0x0008
#define DBMDX_REGV_RESET_DET_STATUS		0x000E
...
#define DBMDX_REGV_FORCE_DETECTION_INTERRUPT	0x0080
...
/* Reg 0X1C */
#define DBMDX_REGN_I2C_SERVICE			0x801C0000
...
#define DBMDX_REGV_CLOSING_MICS_SAR_LOW_AMP				0x0000
#define DBMDX_REGV_SAR_ADC_SEL_SEC					0x0800
#define DBMDX_REGV_SAR_ADC_SEL_MAIN					0x0000


#define DBMDX_REGN_VESPER_MIC_CONFIG		0x80280000

#define DBMDX_REGV_MODE_GPIO_NUM_0		0x0000
#define DBMDX_REGV_MODE_GPIO_NUM_1		0x0001
#define DBMDX_REGV_MODE_GPIO_NUM_2		0x0002
#define DBMDX_REGV_MODE_GPIO_NUM_3		0x0003
#define DBMDX_REGV_MODE_GPIO_NUM_4		0x0004
#define DBMDX_REGV_MODE_GPIO_NUM_5		0x0005
#define DBMDX_REGV_MODE_GPIO_NUM_6		0x0006
#define DBMDX_REGV_MODE_GPIO_NUM_7		0x0007
#define DBMDX_REGV_MODE_GPIO_NUM_8		0x0008
#define DBMDX_REGV_MODE_GPIO_NUM_9		0x0009
#define DBMDX_REGV_MODE_GPIO_NUM_10		0x000A
#define DBMDX_REGV_MODE_GPIO_NUM_11		0x000B
#define DBMDX_REGV_MODE_GPIO_NUM_12		0x000C
#define DBMDX_REGV_MODE_GPIO_NUM_13		0x000D
#define DBMDX_REGV_MODE_GPIO_NUM_14		0x000E
#define DBMDX_REGV_MODE_GPIO_NUM_15		0x000F
#define DBMDX_REGV_MODE_GPIO_NUM_16		0x0010
#define DBMDX_REGV_MODE_GPIO_NUM_17		0x0011
#define DBMDX_REGV_MODE_GPIO_NUM_18		0x0012
#define DBMDX_REGV_MODE_GPIO_NUM_19		0x0013
#define DBMDX_REGV_MODE_GPIO_NUM_20		0x0014
#define DBMDX_REGV_MODE_GPIO_NUM_21		0x0015
#define DBMDX_REGV_MODE_GPIO_NUM_22		0x0016
#define DBMDX_REGV_MODE_GPIO_NUM_23		0x0017
#define DBMDX_REGV_MODE_GPIO_NUM_24		0x0018

#define DBMDX_REGV_ZERO_MIC_OUT_0_MS		0x0000
#define DBMDX_REGV_ZERO_MIC_OUT_1_5_MS		0x0020
#define DBMDX_REGV_ZERO_MIC_OUT_3_MS		0x0040
#define DBMDX_REGV_ZERO_MIC_OUT_4_5_MS		0x0060
#define DBMDX_REGV_ZERO_MIC_OUT_6_MS		0x0080
#define DBMDX_REGV_ZERO_MIC_OUT_7_5_MS		0x00A0
#define DBMDX_REGV_ZERO_MIC_OUT_9_MS		0x00C0
#define DBMDX_REGV_ZERO_MIC_OUT_10_5_MS		0x00E0

#define DBMDX_REGV_DET_GPIO_NUM_0		0x0000
#define DBMDX_REGV_DET_GPIO_NUM_1		0x0100
#define DBMDX_REGV_DET_GPIO_NUM_2		0x0200
#define DBMDX_REGV_DET_GPIO_NUM_3		0x0300
#define DBMDX_REGV_DET_GPIO_NUM_4		0x0400
#define DBMDX_REGV_DET_GPIO_NUM_5		0x0500
#define DBMDX_REGV_DET_GPIO_NUM_6		0x0600
#define DBMDX_REGV_DET_GPIO_NUM_7		0x0700
#define DBMDX_REGV_DET_GPIO_NUM_8		0x0800
#define DBMDX_REGV_DET_GPIO_NUM_9		0x0900
#define DBMDX_REGV_DET_GPIO_NUM_10		0x0a00
#define DBMDX_REGV_DET_GPIO_NUM_11		0x0b00
#define DBMDX_REGV_DET_GPIO_NUM_12		0x0c00
#define DBMDX_REGV_DET_GPIO_NUM_13		0x0d00
#define DBMDX_REGV_DET_GPIO_NUM_14		0x0e00
#define DBMDX_REGV_DET_GPIO_NUM_15		0x0f00
#define DBMDX_REGV_DET_GPIO_NUM_16		0x1000
#define DBMDX_REGV_DET_GPIO_NUM_17		0x1100
#define DBMDX_REGV_DET_GPIO_NUM_18		0x1200
#define DBMDX_REGV_DET_GPIO_NUM_19		0x1300
#define DBMDX_REGV_DET_GPIO_NUM_20		0x1400
#define DBMDX_REGV_DET_GPIO_NUM_21		0x1500
#define DBMDX_REGV_DET_GPIO_NUM_22		0x1600
#define DBMDX_REGV_DET_GPIO_NUM_23		0x1700
#define DBMDX_REGV_DET_GPIO_NUM_24		0x1800

#define DBMDX_REGV_SIL_TIME_THD_250MS		0x0000
#define DBMDX_REGV_SIL_TIME_THD_500MS		0x2000
#define DBMDX_REGV_SIL_TIME_THD_1000MS		0x4000
#define DBMDX_REGV_SIL_TIME_THD_2000MS		0x6000
#define DBMDX_REGV_SIL_TIME_THD_4000MS		0x8000
...
/* Reg 0X2A */
#define DBMDX_REGN_TONE_GENERATOR		0x802A0000

#define DBMDX_REGV_TONE_GEN_EN			0x0001
#define DBMDX_REGV_TONE_WORD_WIDTH_16_BITS	0x0000
#define DBMDX_REGV_TONE_WORD_WIDTH_32_BITS	0x0002

/* Reg 0X2B */
#define DBMDX_REGN_TRIGGER_WORD_ID_FOR_BUFFERING	0x802A0000
/* Values */
#define DBMDX_REGV_WORD_ID_SEL_REG_5C		0x0000
#define DBMDX_REGV_WORD_ID_SEL_REG_5B		0x0001

/* Reg 0X2C */
#define DBMDX_REGN_VT_COMMAND_TIMEOUT		0x802C0000
/* Values */
#define DBMDX_REGV_TIMEOUT_750MS		0x0032
#define DBMDX_REGV_TIMEOUT_3_SEC		0x00C8
#define DBMDX_REGV_TIMEOUT_5_MIN		0x4E20

/* Reg 0X2D */
#define DBMDX_REGN_SPL_METER_CONFIG		0x802C0000

/* Reg 0X2E */
#define DBMDX_REGN_SPL_METER_STATUS		0x802C0000

/* Reg 0X30 */
#define DBMDX_REGN_UART_DEBUG_RECORDING			0x80300000
/* Values */
#define DBMDX_REGV_ENABLE_RECORDING			0x0001
#define DBMDX_REGV_ENLARGE_BUFFER_BY_1_5		0x0002
#define DBMDX_REGV_ENLARGE_BUFFER_BY_2			0x0004
#define DBMDX_REGV_ALLOCATE_BUFFER_IN_AHB_MEMORY	0x0008
#define DBMDX_REGV_ADD_BUFFER_TO_HW_VAD			0x0010
#define DBMDX_REGV_ENABLE_CALCULATING_MAX_VALUES	0x0100
#define DBMDX_REGV_PRINT_MAX_VALUES			0x0200
#define DBMDX_REGV_RECORD_MIC0_INT			0x0001
#define DBMDX_REGV_RECORD_MIC1_INT			0x0002
#define DBMDX_REGV_RECORD_MIC2_INT			0x0004
#define DBMDX_REGV_RECORD_MIC3_INT			0x0008
#define DBMDX_REGV_RECORD_MIC0_FRM			0x0010
#define DBMDX_REGV_RECORD_MIC1_FRM			0x0020
#define DBMDX_REGV_RECORD_MIC2_FRM			0x0040
#define DBMDX_REGV_RECORD_MIC3_FRM			0x0080
#define DBMDX_REGV_RECORD_TDM0_Rx_INT			0x0100
#define DBMDX_REGV_RECORD_TDM1_Rx_INT			0x0200
#define DBMDX_REGV_RECORD_TDM2_Rx_INT			0x0400
#define DBMDX_REGV_RECORD_TDM3_Rx_INT			0x0800
#define DBMDX_REGV_RECORD_TDM0_Tx_INT			0x1000
#define DBMDX_REGV_RECORD_TDM1_Tx_INT			0x2000
#define DBMDX_REGV_RECORD_TDM2_Tx_INT			0x4000
#define DBMDX_REGV_RECORD_TDM3_Tx_INT			0x8000
#define DBMDX_REGV_RECORD_TDM0_Rx_FRM			0x0001
#define DBMDX_REGV_RECORD_TDM1_Rx_FRM			0x0002
#define DBMDX_REGV_RECORD_TDM2_Rx_FRM			0x0004
#define DBMDX_REGV_RECORD_TDM3_Rx_FRM			0x0008
#define DBMDX_REGV_RECORD_TDM0_Tx_FRM			0x0010
#define DBMDX_REGV_RECORD_TDM1_Tx_FRM			0x0020
#define DBMDX_REGV_RECORD_TDM2_Tx_FRM			0x0040
#define DBMDX_REGV_RECORD_TDM3_Tx_FRM			0x0080
#define DBMDX_REGV_RECORD_BUF1_IN_FRM			0x0100
#define DBMDX_REGV_RECORD_BUF2_IN_FRM			0x0200
#define DBMDX_REGV_RECORD_BUF3_IN_FRM			0x0400
#define DBMDX_REGV_RECORD_BUF4_IN_FRM			0x0800
#define DBMDX_REGV_RECORD_BUF1_OUT_FRM			0x1000
#define DBMDX_REGV_RECORD_BUF2_OUT_FRM			0x2000
#define DBMDX_REGV_RECORD_BUF3_OUT_FRM			0x4000
#define DBMDX_REGV_RECORD_BUF4_OUT_FRM			0x8000
#define DBMDX_REGV_RECORD_VT_IN				0x0001
#define DBMDX_REGV_RECORD_BUF_8_OUT			0x0002
#define DBMDX_REGV_RECORD_BUF_9_OUT			0x0004
#define DBMDX_REGV_RECORD_DECIM_IN_0			0x0008
#define DBMDX_REGV_RECORD_DECIM_IN_1			0x0010
...
#define DBMDX_REGV_RX_TX_I2S_CH_USE_I2S_STEREO			0x0000
#define DBMDX_REGV_TX_I2S_CH_SUM_HIGH_AND_LOW_INTO_ONE_SAMPLE	0x0100
#define DBMDX_REGV_TX_MASTER_CLOCK_ONLY				0x0200
#define DBMDX_REGV_TX_FULL_OPERATION				0x0000
...
/* Reg 0X39 */
#define DBMDX_REGN_SPI_TRANSFER_BLOCK					0x80390000
...
/* Reg 0X300 */
#define DBMDX_REGN_VT_MAPPING			0x83000000
#define DBMDX_REGV_VT_ENG_NONE			0x0000
#define DBMDX_REGV_VT_ENG_1				0x0001
#define DBMDX_REGV_VT_ENG_ALEXA			0x0002
#define DBMDX_REGV_VT_ENG_3				0x0003
#define DBMDX_REGV_VT_ENG_4				0x0004

/* Reg 0X301 */
#define DBMDX_REGN_VT_FRAMING_SIZE		0x83010000
#define DBMDX_REGN_SELECT_VT_INDEX		0x83010000

#define DBMDX_REGV_SELECT_VT_EN_GLOBAL		0x0000
#define DBMDX_REGV_SELECT_VT_EN_1		0x2000
#define DBMDX_REGV_SELECT_VT_EN_2		0x4000
#define DBMDX_REGV_SELECT_VT_EN_3		0x6000
#define DBMDX_REGV_SELECT_VT_EN_NONE		0xE000

#define DBMDX_REGV_FRAME_SIZE_MASK		0x03FF


/* Reg 0X304 */
#define DBMDX_REGN_VT_GENERAL_CONFIG		0x83040000
/* Values */
#define DBMDX_REGV_VT_EN_DIS			0x0000
#define DBMDX_REGV_VT_EN_EN			0x1000
#define DBMDX_REGV_VT_ACTIVE			0x0800
#define DBMDX_REGV_VT_PAUSE			0x0000
#define DBMDX_REGV_SET_IN_CP			0x0010
#define DBMDX_REGV_IN_CP_NUM_0			0x0000
#define DBMDX_REGV_IN_CP_NUM_1			0x0001
#define DBMDX_REGV_IN_CP_NUM_2			0x0002
#define DBMDX_REGV_IN_CP_NUM_3			0x0003
#define DBMDX_REGV_IN_CP_NUM_4			0x0004
#define DBMDX_REGV_IN_CP_NUM_5			0x0005
#define DBMDX_REGV_IN_CP_NUM_6			0x0006
#define DBMDX_REGV_IN_CP_NUM_7			0x0007

/* Reg 0X305 */
#define DBMDX_REGN_VT_AUDIO_HISTORY_CFG			0x83050000
/* Values */
#define DBMDX_REGV_START_BUF_READ			0x1000
#define DBMDX_REGV_EXT_HIST_TIME_500MS			0x01F4
#define DBMDX_REGV_EXT_HIST_TIME_750MS			0x05DC
#define DBMDX_REGV_EXT_HIST_TIME_1S			0x03E8
#define DBMDX_REGV_HIST_POINT_IS_SWITCH_TO_BUFFER	0x0000
#define DBMDX_REGV_HIST_POINT_IS_WW_END			0x0001
#define DBMDX_REGV_HIST_POINT_IS_WW_START		0x0002

/* Reg 0X306 */
#define DBMDX_REGN_VT_RECORD_CFG		0x83060000
/* Values */
#define DBMDX_REGN_OUT_SIZE_SAME		0x0000
#define DBMDX_REGV_OUT_SIZE_EXPANDED		0x0200
#define DBMDX_REGV_MARK_DET			0x0100
#define DBMDX_REGV_REC_OUT_DATA			0x0010
#define DBMDX_REGV_REC_IN_DATA			0x0001



#define DBMDX_REGN_VT1_REGS_OFFSET		0x80400000
#define DBMDX_REGN_VT2_REGS_OFFSET		0x80800000
#define DBMDX_REGN_VT3_REGS_OFFSET		0x80C00000
/* VT Engines offsets */
#define DBMDX_REGN_VT_REG_RECOG_MODE		0x00000000
#define DBMDX_REGN_VT_REG_INIT			0x00010000
#define DBMDX_REGN_VT_REG_LPSD			0x00020000
#define DBMDX_REGN_VT_REG_TH			0x00000000
#define DBMDX_REGN_VT_REG_ACTIVE_MODEL		0x00090000
#define DBMDX_REGN_VT_REG_LL			0x000A0000
#define DBMDX_REGN_VT_REG_LPSD_STATE		0x00130000
#define DBMDX_REGN_VT_REG_WORD_ID		0x001B0000
#define DBMDX_REGN_VT_REG_ALT_WORD_ID		0x001C0000
#define DBMDX_REGN_VT_REG_FINAL_SCORE		0x001D0000
#define DBMDX_REGN_VT_REG_PHRASE_LENGTH		0x00270000



#define DBMDX_REGV_USER_CFG_WWE_LENGTH_500_MS	2000
#define DBMDX_REGV_USER_CFG_WWE_LENGTH_750_MS	3000
#define DBMDX_REGV_USER_CFG_WWE_LENGTH_1S	4000
...
#define DBMD4_DTCM_MEM_START			0x0
#define DBMD4_DTCM_MEM_END			0x17fff
#define DBMD4_AHB_DATA_MEM_START	0x0500a000
#define DBMD4_AHB_DATA_MEM_END		0x05029fff
