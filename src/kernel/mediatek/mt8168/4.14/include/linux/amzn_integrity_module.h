...
// ADC Scale factor = 1500 / 4096
// ADC Pull up resistor = R1 = 390K ohms
// ADC Pull down resistor = R2 = 16.9K ohms
// VBUS Scale factor = (ADC scale factor) * (R1 + R2) / (R2)
#define ABC_VBUS_SCALE_FACTOR                     8817
