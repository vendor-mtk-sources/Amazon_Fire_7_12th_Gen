...
#include "../../drivers/misc/mediatek/include/mt-plat/mt8168/include/mach/upmu_hw.h"

/*
 * Define the registers used by sign of life driver.
 */
#define SHUTDOWN_REASON_REG		PMIC_RTC_SPAR0_ADDR
#define THERMAL_SHUTDOWN_REASON_REG	PMIC_RTC_SPAR0_ADDR
#define BOOT_REASON_REG			PMIC_AL_DOW_ADDR
#define PARITY_REG			PMIC_AL_DOW_ADDR
#define QUIE_REG			PMIC_AL_DOW_ADDR
 ...
 *		bit 10 - bit 12: life cycle shutdown reason
 *		bit 13 - bit 15: life cycle thermal shutdown reason
 */
#define RTC_SHUTDOWN_MASK		0x1C00
#define RTC_SHUTDOWN_SHIFT		10

#define RTC_THERMAL_SHUTDOWN_MASK	0xE000
#define RTC_THERMAL_SHUTDOWN_SHIFT	13

/*
 * RTC_AL_DOW:
 *	bit 8 - 15 : Use for life cycle reason
 *		bit 8 -  10 : life cycle boot reason
 *		bit 11 - 13 : life cycle special mode reason
 *		bit 14: life cycle parity check bit
		bit 15: quiescent mode check bit
 */
#define RTC_BOOT_MASK			0x0700
#define RTC_BOOT_SHIFT			8
