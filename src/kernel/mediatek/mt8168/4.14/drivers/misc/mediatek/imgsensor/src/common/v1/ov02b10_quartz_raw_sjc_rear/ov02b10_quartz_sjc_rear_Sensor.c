...
#include "ov02b10_quartz_sjc_rear_Sensor.h"

#define PFX "ov02b10_quartz_sjc_rear_camera_sensor"
#define LOG_1 LOG_INF("ov02b10_quartz_sjc_rear_camera_sensor, MIPI 1LANE\n")
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = OV02B10_QUARTZ_SJC_REAR_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	{1600, 1200, 0, 0, 1600, 1200, 1600, 1200, 0,
		0, 1600, 1200, 0, 0, 1600, 1200}, // Preview
	{1600, 1200, 0, 0, 1600, 1200, 1600, 1200, 0,
		0, 1600, 1200, 0, 0, 1600, 1200}, // capture
	{1600, 1200, 0, 0, 1600, 1200, 1600, 1200, 0,
		0, 1600, 1200, 0, 0, 1600, 1200}, // video
	{1600, 1200, 0, 0, 1600, 1200, 1600, 1200, 0,
		0, 1600, 1200, 0, 0, 1600, 1200}, // hight video 120
	{1600, 1200, 0, 0, 1600, 1200, 1600, 1200, 0,
		0, 1600, 1200, 0, 0, 1600, 1200}, // slim video
	{1600, 1200, 0, 0, 1600, 1200, 1600, 1200, 0,
		0, 1600, 1200, 0, 0, 1600, 1200}, // custom1
};
				...
				kal_uint16 shutter, kal_uint16 frame_length)
{
	...
	if (imgsensor.autoflicker_en) {
		...
		if (realtime_fps >= 297 && realtime_fps <= 305)
			...
			/* Extend frame length*/
			write_cmos_sensor(0xfd, 0x01);
			write_cmos_sensor(0x14,
							((imgsensor.frame_length-1220) & 0x7F00) >> 8);
			write_cmos_sensor(0x15, (imgsensor.frame_length-1220) & 0xFF);
			write_cmos_sensor(0xfe, 0x02);
		}
	} else {
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		spin_unlock(&imgsensor_drv_lock);
		do {
			write_cmos_sensor(0xfd, 0x00); // system registers OTP
			*sensor_id = ((read_cmos_sensor(0x0200) << 8) |
							read_cmos_sensor(0x0300));
				...
				MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if (imgsensor.test_pattern == KAL_TRUE)
		...
		write_cmos_sensor(0x5000,
							((read_cmos_sensor(0x5000) & 0xBF) | 0x00));
...
UINT32 OV02B10_QUARTZ_SJC_REAR_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
