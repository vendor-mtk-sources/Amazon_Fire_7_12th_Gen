 ...
 * Filename:
 * ---------
 *    gc02m1_quartz_lce_rear_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "gc02m1_quartz_lce_rear_Sensor.h"

/************* Modify Following Strings for Debug ****************/
#define PFX "gc02m1_quartz_lce_rear_camera_sensor"
#define LOG_1 LOG_INF("gc02m1_quartz_lce_rear_camera_sensor, MIPI 1LANE\n")
/********************** Modify end  ******************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_QUARTZ_LCE_REAR_SENSOR_ID,
...
UINT32 GC02M1_QUARTZ_LCE_REAR_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
