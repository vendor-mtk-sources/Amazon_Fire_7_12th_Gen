...
#define ST7703I_3POWER_UNKNOWN		0xFF
...
static int lcm_driver_probe(struct device *dev)
{
	...
	pr_notice("[LCM][St7703i] %s Default transmission mode: mipi\n",
					__func__);
...
static const struct of_device_id lcm_platform_of_match[] = {
	{.compatible = "st,st7703i_3power_kd_boe",},
	{.compatible = "st,st7703i_3power_truly_truly",},
	{},
};
...
static int lcm_platform_probe(struct platform_device *pdev)
{
	...
	unsigned int panel_id = ST7703I_3POWER_UNKNOWN;
	int ret = 0;
...
{
	pr_notice("[LCM][St7703i]: Register lcm driver\n");
	if (platform_driver_register(&lcm_driver)) {
		pr_notice("[LCM][St7703i]: failed to register disp driver\n");
		return -ENODEV;
	}
...
static void __exit lcm_drv_exit(void)
{
	...
	pr_notice("[LCM][St7703i]: Unregister lcm driver done\n");
}
...
#define ST7703I_3POWER_KD_BOE		3
#define ST7703I_3POWER_TRULY_TRULY	5
...
static struct LCM_setting_table lcm_init_truly_truly[] = {
	{0x11,	0,	{ } },
	{REGFLAG_DELAY, 120, { } },
	{0x29,  0,      { } },
	{REGFLAG_DELAY, 20, {} },
...
static void lcm_get_3power_st7703i_params(struct LCM_PARAMS *params)
{
	...
	if (lcm_data.lcm_id == ST7703I_3POWER_KD_BOE) {
	...
	} else if (lcm_data.lcm_id == ST7703I_3POWER_TRULY_TRULY) {
		params->dsi.vertical_sync_active	= 6;
		params->dsi.vertical_backporch		= 16;
		params->dsi.vertical_frontporch		= 35;
		params->dsi.vertical_active_line	= FRAME_HEIGHT;
...
static void init_st7703i_lcm(void)
{
	if (lcm_data.lcm_id == ST7703I_3POWER_KD_BOE)
		...
		push_table(lcm_init_truly_truly,
			sizeof(lcm_init_truly_truly) / sizeof(struct LCM_setting_table),
			1);
	else {
...
struct LCM_DRIVER st7703i_wsvga_dsi_vdo_3power_quartz_lcm_drv = {
	.name           = "st7703i_wsvga_dsi_vdo_3power_quartz",
	.set_util_funcs = lcm_set_util_funcs,
	.get_params     = lcm_get_3power_st7703i_params,
	.init           = lcm_init,
