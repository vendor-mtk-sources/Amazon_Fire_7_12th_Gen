...
#include "mmdvfs_config_mt8168.h"
#endif
...
#elif defined(SMI_AQU)
struct mmdvfs_step_util mmdvfs_step_util_obj_mt8168 = {
	{0},
	MMDVFS_SCEN_COUNT,
	{0},
	MT8168_MMDVFS_OPP_MAX,
	MMDVFS_FINE_STEP_OPP0,
	mmdvfs_step_util_init,
	mmdvfs_step_util_set_step,
};
...
#elif defined(SMI_AQU)
struct mmdvfs_adaptor mmdvfs_adaptor_obj_mt8168 = {
	0, 0, 0, 0,
	NULL, 0,
	NULL, 0,
	mt8168_step_profile, MT8168_MMDVFS_OPP_MAX,
	0,
	mmdvfs_profile_dump,
	mmdvfs_single_hw_config_dump,
	mmdvfs_hw_config_dump,
...
#endif
		break;
	case MMDVFS_PROFILE_AQU:
#if defined(SMI_AQU)
		g_mmdvfs_adaptor = &mmdvfs_adaptor_obj_mt8168;
		g_mmdvfs_step_util = &mmdvfs_step_util_obj_mt8168;
		g_mmdvfs_threshandler = &mmdvfs_thres_handler_obj;
#endif
		break;
	default:
