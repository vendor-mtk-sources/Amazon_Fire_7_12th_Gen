			...
			const char __user *buf, size_t size, loff_t *ppos)
{
	...
	for (i = 0; i < nr_cpu_ids; i++) {
		n = snprintf(name, sizeof(name), "wd-test-%d", i);
...
#define TEST_EE_PHY_SIZE	65536
	...
	if (ptr == NULL)
		return snprintf(buffer, BUFSIZE, "kmalloc fail\n");
	...
	return snprintf(buffer, BUFSIZE, "Modem EE Generated\n");
}
...
#define TEST_COMBO_PHY_SIZE	65536
	...
	return snprintf(buffer, BUFSIZE, "Combo EE Generated\n");
}
...
#define TEST_MD32_PHY_SIZE	65536
	...
	len = snprintf(buffer, BUFSIZE, "MD32 EE log here\n");
	if (len < 0)
		pr_err("%s: snprintf error\n", __func__);
	...
	return snprintf(buffer, BUFSIZE, "MD32 EE Generated\n");
}
...
#define TEST_SCP_PHY_SIZE	65536
	...
	len = snprintf(buffer, BUFSIZE, "SCP EE log here\n");
	if (len < 0)
		pr_err("%s: snprintf error\n", __func__);
	...
	return snprintf(buffer, BUFSIZE, "SCP EE Generated\n");
}
				      ...
				      loff_t *ppos)
{
	...
	len = snprintf(buffer, BUFSIZE, "DAL Generated\n");
