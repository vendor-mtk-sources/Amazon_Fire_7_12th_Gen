 ...
 * Filename:
 * ---------
 *     ov02b10_quartz_sjc_front_Sensor.h
 *
 * Project:
 * --------
 *     ALPS
 ...
 *
 ****************************************************************************/
#ifndef __OV02B10_QUARTZ_SJC_FRONT_SENSOR_H__
#define __OV02B10_QUARTZ_SJC_FRONT_SENSOR_H__


/* SENSOR PRIVATE INFO FOR GAIN SETTING */
#define OV02B10_SENSOR_GAIN_BASE             0x400
#define OV02B10_SENSOR_GAIN_MAX              (12 * OV02B10_SENSOR_GAIN_BASE)
#define OV02B10_SENSOR_GAIN_MAX_VALID_INDEX  16
#define OV02B10_SENSOR_GAIN_MAP_SIZE         16
#define OV02B10_SENSOR_DGAIN_BASE            0x400
...
struct imgsensor_struct {
	...
	kal_uint8  ihdr_en;            //ihdr mode 0: disable, 1: ihdr, 2:mVHDR, 9:zigzag
