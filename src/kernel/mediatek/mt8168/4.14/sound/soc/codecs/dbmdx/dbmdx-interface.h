...
#if defined(CONFIG_SND_SOC_DBMDX_GENERAL_WWE_SUPPORT)
#if !defined(DMBDX_GENERAL_AMODEL_SUPPORT)
#define DMBDX_GENERAL_AMODEL_SUPPORT	1
#endif
#endif


#if defined(CONFIG_SND_SOC_DBMDX_ALEXA_WWE_SUPPORT)
#if !defined(DMBDX_ALEXA_AMODEL_SUPPORT)
#define DMBDX_ALEXA_AMODEL_SUPPORT	1
#endif
#endif
...
#if defined(CONFIG_SND_SOC_DBMDX_SAR_ADC_SELECT_MIC2)
#if !defined(DBMDX_SAR_ADC_SELECT_SEC)
#define DBMDX_SAR_ADC_SELECT_SEC		1
#endif
#endif

#ifdef USE_KERNEL_ABOVE_4_17_XX
#define SND_SOC_COMPONENT
#define TIMER_LIST_PTR
#endif

#ifdef USE_KERNEL_ABOVE_4_19_10
#define WAKEUP_SOURCE_REGISTER
#endif
...
#define DBMDX_ALEXA_VT_AMODEL_NAME		"dsp_quartz_model.bin"
#endif
...
#define DBMDX_MAX_SUPPORTED_VT_ENGINES		3
...
#define DBMDX_MSLEEP_CONFIG_HOST_CLOCK_32KHZ	110
#define DBMDX_MSLEEP_TDM_ACTIVATION		40
#define DBMDX_MSLEEP_TDM_DEACTIVATION		120
#define DBMDX_MSLEEP_BUFFERING_PAUSED		100
#define DBMDX_MSLEEP_AFTER_MIC_ENABLED		100
#define DBMDX_MSLEEP_IS_ALIVE			50
#define DBMDX_MSLEEP_IF_AUDIO_BUFFER_EMPTY	90
#define DBMDX_MSLEEP_SET_MODE			40
#define DBMDX_MSLEEP_ENABLE_VTE_DETECTION	30
#define DBMDX_MSLEEP_DISABLE_VTE		100
#define DBMDX_MSLEEP_SAR_MIC_SEC_CONFIG		100
#define DBMDX_MSLEEP_MODEL_LOAD			30
...
#define DBMDX_USLEEP_CONFIG_HOST_CLOCK		15000
#define DBMDX_USLEEP_MIC_CONFIG			1000
...
#define DBMDX_USLEEP_UART_AFTER_LOAD_AMOfsDEL	10000
...
#define DBMDX_FRAME_LENGTH			512
#define DBMDX_SYSTEM_FRAME_OFFSET		3
#define DBMDX_INTERRUPT_DELAY_TIME		30
#define MAX_AMODEL_PREFIX_INDEX			127
...
#ifndef DBMDX_MAX_VA_PLL
#define DBMDX_MAX_VA_PLL	140000000
#endif

#ifndef DBMDX_MAX_VA_VE_PLL
#define DBMDX_MAX_VA_VE_PLL	340000000
#endif
...
#define	DBMDX_MIC_DISABLE_VAL		DBMDX_REGV_CLOSING_MICS_SAR_LOW_AMP
#else
#define DBMDX_MIC_DISABLE_VAL		DBMDX_REGV_CLOSING_MICS_NO_DM_CLOCK
#endif
#endif
...
struct va_flags {
	...
	int	cancel_pm_work;
	unsigned int	mode;
	unsigned int	number_of_vt_since_start;
	u16		gain_normalization_val;
	bool		gain_normalization_disabled;
};
...
struct va_ve_flags {
	...
	unsigned int	mode;
	unsigned int	ignore_vt_data;
};

enum dbmdx_va_ve_project_sub_types {
	DBMDX_VA_VE_PROJECT_SUB_TYPE_0 = 0,
	DBMDX_VA_VE_PROJECT_SUB_TYPE_VT_ONLY = 1,
	DBMDX_VA_VE_PROJECT_SUB_TYPE_2 = 2,
};
#endif

#define DBMDX_VT_MODE_SUPPORT_PHRASE		0x0001
#define DBMDX_VT_MODE_SUPPORT_VOICE_ENERGY	0x0002
#define DBMDX_VT_MODE_SUPPORT_VOICE_COMMAND	0x0004
#define DBMDX_VT_MODE_SUPPORT_VOICE_DUAL	0x0008

enum dbmdx_model_state {
...
extern const char *dbmdx_model_state_names[MODEL_STATE_MAX];

enum dbmdx_model_detection_type {
	DETECTION_TYPE_PHRASE = 0,
	DETECTION_TYPE_VOICE_ENERGY,
	DETECTION_TYPE_VOICE_COMMAND,
	DETECTION_TYPE_DUAL,
	DETECTION_TYPE_MAX,
};

extern const char *dbmdx_vte_det_type_names[DETECTION_TYPE_MAX];


enum dbmdx_vt_engine_type {
	DBMDX_VT_ENGINE_TYPE_UNDEFINED = 0,
	DBMDX_VT_ENGINE_TYPE_1,
	DBMDX_VT_ENGINE_TYPE_ALEXA,
	DBMDX_VT_ENGINE_TYPE_3,
	DBMDX_VT_ENGINE_TYPE_4,
	DBMDX_VT_ENGINE_TYPE_GENERAL,
	DBMDX_VT_ENGINE_TYPE_MAX,
};

extern const char *dbmdx_vte_names[DBMDX_VT_ENGINE_TYPE_MAX];

struct clock_config {
	u32 wanted_pll;
	u32 wanted_tl3_clk;
	u32 wanted_tl3_clk_debug;
	u32 wanted_ahb_clk;
	u32 wanted_apb_clk;
...
enum clock_type {
	DBMDX_CLOCK_FROM_MASTER = 0,
	DBMDX_CLOCK_FROM_TDM,
};

enum dbmdx_clock_op {
	DBMDX_CLOCK_OP_DO_NOT_CONFIG = 0,
...
enum dbmdx_load_amodel_mode {
	...
	LOAD_AMODEL_MAX = LOAD_AMODEL_2NDARY,
};
...
struct vt_engine {
	/* Status */
	enum dbmdx_model_state user_state;
	enum dbmdx_model_detection_type user_detection_type;
	enum dbmdx_model_state internal_state;
	enum dbmdx_model_detection_type detection_type;
	bool loaded_to_fw;
	bool started;
	enum dbmdx_mem_loc mem_loc;

	/* Setup */
	bool enabled;
	u16 vte_index;
	u32 amodel_options;
	u32 mode_support_mask;
	enum dbmdx_vt_engine_type eng_type;
	int num_of_amodel_files[DETECTION_TYPE_MAX];
	const char *amodel_fnames[DETECTION_TYPE_MAX][DBMDX_AMODEL_MAX_CHUNKS];
	int num_of_amodel_files_sec;
	const char *amodel_fnames_sec[DBMDX_AMODEL_MAX_CHUNKS];
	/* Model Data */
	struct amodel_info primary_model;
	struct amodel_info secondary_model;
	struct amodel_info ve_model;
	struct amodel_info vc_model;

	u32 *history;
	u32 frame_size;
	u32 cp;
	u32 custom_params;
	int (*verify_model_load)(struct dbmdx_private *p, u16 vt_index);
};
...
struct dbmdx_private {
	...
	bool				device_ready;
#ifdef DBMDX_VA_VE_SUPPORT
	enum clock_type			cur_va_clock;
	enum clock_type			cur_va_ve_clock;
	bool				asleep_va;
	bool				asleep_va_ve;
	...
	struct usecase_config		*idle_usecase;
#endif
	...
	void (*usr_op_lock)(struct dbmdx_private *p);
	void (*usr_op_unlock)(struct dbmdx_private *p);
...
struct chip_interface {
	...
	/* Read DSP log */
	int (*read_dsp_log)(u8 *src, u8 *dest, int size);
	/* private data */
	void *pdata;
};
