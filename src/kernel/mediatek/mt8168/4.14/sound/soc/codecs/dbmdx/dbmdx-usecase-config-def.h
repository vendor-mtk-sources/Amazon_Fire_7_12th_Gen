...
#define DBMDX_USECASE_ID_PRJ_abc123		0x0010
#define DBMDX_USECASE_ID_PRJ_aca123		0x0020
#define DBMDX_USECASE_ID_PRJ_ada123		0x0030
#define DBMDX_USECASE_ID_PRJ_aea123		0x0040
...
struct usecase_config {
	...
	enum dbmdx_clock_op	clock_op_va_i2s_master;
