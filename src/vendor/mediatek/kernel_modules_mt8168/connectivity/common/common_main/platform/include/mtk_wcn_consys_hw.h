...
typedef VOID(*CONSYS_IC_CLK_CTRL) (UINT32 enable);
...
typedef struct _WMT_CONSYS_IC_OPS_ {
	...
	CONSYS_IC_CLK_CTRL consys_ic_clk_ctrl;
#if defined(CONFIG_MTK_COMBO_PEREGRINE)
	VOID(*consys_ic_inc_bt_spi_driving)(VOID);
	VOID(*consys_ic_inc_wifi_spi_driving)(VOID);
#endif
