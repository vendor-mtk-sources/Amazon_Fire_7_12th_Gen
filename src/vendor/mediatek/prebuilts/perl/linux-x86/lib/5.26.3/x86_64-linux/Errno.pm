...
"x86_64-linux-4.9.0-040900-generic" or
	die "Errno architecture (x86_64-linux-4.9.0-040900-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
