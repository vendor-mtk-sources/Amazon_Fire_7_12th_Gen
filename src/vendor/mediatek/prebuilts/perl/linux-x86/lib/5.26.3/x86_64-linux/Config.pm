...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/5.26.3/x86_64-linux'),
    ...
    osname => 'linux',
    osvers => '4.9.0-040900-generic',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/5.26.3'),
    scriptdir => '.../',
    sitearchexp => relocate_inc('.../../lib/site_perl/5.26.3/x86_64-linux'),
    sitelibexp => relocate_inc('.../../lib/site_perl/5.26.3'),
    so => 'so',
    useithreads => undef,
